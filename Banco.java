                ...
                switch (entrada){
                    ...
                    case "Procurar Conta":
                        ...
                        do{
                            ...
                            if(achou == true){
                                JOptionPane.showMessageDialog(null, "CONTA ENCONTRADA","Bem vindo " + contas.get(pos).getDono(),1);
                                boolean correta = false;
                                int tentativas = 0;
                                do{
                                    entrada = JOptionPane.showInputDialog(null,"Bem vindo " + contas.get(pos).getDono() + "\ninforme sua senha: ","Login",1);
                                    ...
                                    for(i=0; i<contas.size(); i++){
                                        ...
                                        if(contas.get(pos).getSenha() == senha){
                                            correta = true;
                                            break;
                                        }
                                    }
                                    ...
                                    if(correta == true){
                                        contas.get(pos).opcoes();
                                        if(contas.get(pos).getStatus() == false){
                                            contas.remove(pos);
                                        }
                                    }else{
